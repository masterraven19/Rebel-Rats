...
public class rebelrats_spinalDoldrumsEffect implements EveryFrameWeaponEffectPlugin {
    final Vector2f endSize = new Vector2f(40,40);
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        p.addExplosion("graphics/fx/explosion0.png",null,size,size,loc,weapon.getShip().getVelocity(),new Color(67,67,222,255),0.1f,0.1f,0,0,angle,1,false);
